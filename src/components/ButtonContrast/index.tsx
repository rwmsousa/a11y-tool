      ...
      if (localStorage.getItem('storageContrast') != '1') {
        ...
        if (elements) {
          for (let i = 0; i < elements.length; i += 1) {
            ...
            if (tag.getAttribute('class') === 'floatingIcon') tag.style.border = '1px solid white';
            document.getElementsByClassName('floatingIcon')[ 0 ].children[ 0 ].setAttribute('fill', 'white');
          }
        }
      } else {
        if (elements) {
          for (let i = 0; i < elements.length; i += 1) {
            ...
            if (tag.getAttribute('class') === 'a11yIcon') tag.style.border = '1px solid black';
            if (tag.getAttribute('class') === 'floatingIcon') {
              tag.style.border = '1px solid white';
              tag.style.background = '#0000ff';
            }
            document.getElementsByClassName('floatingIcon')[ 0 ].children[ 0 ].setAttribute('fill', '#ffffff');
          }
        }
      }
    } catch (error) {
