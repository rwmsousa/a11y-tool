      ...
      if (elements)
        for (let i = 0; i < elements.length; i += 1) {
          ...
          if (
            ...
            const fontSizeOriginal = Number(
              getComputedStyle(tag).fontSize.replace('px', ''),
            );
            tag.style.fontSize =
              `${genSizeCalc(Number(fontSizeOriginal))}`.slice(0, 5) + 'px';
          }
